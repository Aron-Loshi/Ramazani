...
// const ramazanit = document.querySelector("#ramazani tbody");


// for (let i = 0; i < jsonData.vaktiaa.length; i++) {
//     const ramazan = jsonData.vaktiaa[i];

//     const row = tableBody.insertRow();

//     row.insertCell(0).innerHTML = ramazan.Data;
//     row.insertCell(1).innerHTML = ramazan.Muaji;
//     row.insertCell(2).innerHTML = ramazan.Dita;
//     row.insertCell(3).innerHTML = ramazan.syfyri;
//     row.insertCell(4).innerHTML = ramazan.lindja_e_diellit;
//     row.insertCell(5).innerHTML = ramazan.dreka;
//     row.insertCell(6).innerHTML = ramazan.ikindia;
//     row.insertCell(7).innerHTML = ramazan.akshami;
//     row.insertCell(8).innerHTML = ramazan.jacia;
//     row.insertCell(9).innerHTML = ramazan.gjatesia_e_dites;
//     row.insertCell(10).innerHTML = ramazan.shenime;
// }
